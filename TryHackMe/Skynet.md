...
- If done correctly, we can see that we have a shell on the target machine. From here, we can stabilize it with Python. More information regarding stabilizing shells can be found here [[Important Python Syntax and Techniques]]:
```python
